...
(:init
    ...
    (delivery_destination wp0) (at 346.008 (not (delivery_destination wp0)))
    (delivery_destination wp1) (at 346.008 (not (delivery_destination wp1)))
    (delivery_destination wp2) (at 346.008 (not (delivery_destination wp2)))
