...
(:init
    (connected mission_site_start_point_0 mission_site_start_point_1)
    (connected mission_site_start_point_0 wp_auv0)
    (connected wp_auv0 mission_site_start_point_0)
    (connected mission_site_start_point_1 mission_site_start_point_0)
    (connected mission_site_start_point_1 wp_auv0)
    (connected wp_auv0 mission_site_start_point_1)
    ...
    (= (distance mission_site_start_point_0 mission_site_start_point_1) 53.8888)
    (= (distance mission_site_start_point_0 wp_auv0) 56.7891)
    (= (distance wp_auv0 mission_site_start_point_0) 56.7891)
    (= (distance mission_site_start_point_1 mission_site_start_point_0) 53.8888)
    (= (distance mission_site_start_point_1 wp_auv0) 22.561)
    (= (distance wp_auv0 mission_site_start_point_1) 22.561)
