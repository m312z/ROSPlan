...
(:init
    ...
    (at 1477.48 (not (delivery_destination wp0)))
    (at 1477.48 (not (delivery_destination wp1)))
    (at 1477.48 (not (delivery_destination wp2)))
    (at 1477.48 (not (delivery_destination wp3)))
