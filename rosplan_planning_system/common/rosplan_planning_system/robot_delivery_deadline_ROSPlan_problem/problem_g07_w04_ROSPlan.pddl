...
(:init
    ...
    (at 3076.15 (not (delivery_destination wp0)))
    (at 3076.15 (not (delivery_destination wp1)))
    (at 3076.15 (not (delivery_destination wp2)))
    (at 3076.15 (not (delivery_destination wp3)))
    (at 3076.15 (not (delivery_destination wp4)))
