...
(:init
    ...
    (at 241.268 (not (delivery_destination wp0)))
    (at 241.268 (not (delivery_destination wp1)))
    (at 241.268 (not (delivery_destination wp2)))
    (at 241.268 (not (delivery_destination wp3)))
    (at 241.268 (not (delivery_destination wp4)))
