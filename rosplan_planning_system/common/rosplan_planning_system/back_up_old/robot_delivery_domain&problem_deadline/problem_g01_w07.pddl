...
(:init
    ...
    (at 687.75 (not (delivery_destination wp0)))
    (delivery_destination wp1)
    (at 687.75 (not (delivery_destination wp1)))
    (delivery_destination wp2)
    (at 687.75 (not (delivery_destination wp2)))
    (delivery_destination wp3)
    (at 687.75 (not (delivery_destination wp3)))
    (delivery_destination wp4)
    (at 687.75 (not (delivery_destination wp4)))
    (delivery_destination wp5)
    (at 687.75 (not (delivery_destination wp5)))
    (delivery_destination wp6)
    (at 687.75 (not (delivery_destination wp6)))
