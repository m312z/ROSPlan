...
(:init
    ...
    (delivery_destination wp3)  (at 1000.005 (not (delivery_destination wp3)))
    (delivery_destination wp4)  (at 1000.005 (not (delivery_destination wp4)))
    (delivery_destination wp5)  (at 1000.005 (not (delivery_destination wp5)))
