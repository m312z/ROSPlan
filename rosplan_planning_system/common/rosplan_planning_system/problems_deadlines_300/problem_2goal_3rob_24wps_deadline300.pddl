...
(:init
    ...
    (delivery_destination wp0)  (at 960.0060000000001 (not (delivery_destination wp0)))
    (delivery_destination wp1)  (at 960.0060000000001 (not (delivery_destination wp1)))
    (delivery_destination wp2)  (at 960.0060000000001 (not (delivery_destination wp2)))
    (delivery_destination wp3)  (at 960.0060000000001 (not (delivery_destination wp3)))
