...
(:init
    ...
    (delivery_destination wp0)  (at 870.0060000000001 (not (delivery_destination wp0)))
    (delivery_destination wp1)  (at 870.0060000000001 (not (delivery_destination wp1)))
    (delivery_destination wp2)  (at 870.0060000000001 (not (delivery_destination wp2)))
    (delivery_destination wp3)  (at 870.0060000000001 (not (delivery_destination wp3)))
    (delivery_destination wp4)  (at 870.0060000000001 (not (delivery_destination wp4)))
    (delivery_destination wp5)  (at 870.0060000000001 (not (delivery_destination wp5)))
    (delivery_destination wp6)  (at 870.0060000000001 (not (delivery_destination wp6)))
