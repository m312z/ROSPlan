...
(:init
    ...
    (delivery_destination wp0) (at 465.00300000000004 (not (delivery_destination wp0)))
    (delivery_destination wp1) (at 465.00300000000004 (not (delivery_destination wp1)))
    (delivery_destination wp2) (at 465.00300000000004 (not (delivery_destination wp2)))
