...
stn_file = open(sys.argv[1] + "_09.stn", "w") 
...
for key,value in dict_action.iteritems():
	val1 = int(key)
	#print(dict_action)
	if key != "0" and val1 < total_action:
		#print(val1)
		val2 = val1 - 1
		val3 = float(dict_action[key]- 0.09 * (dict_action[key]))
		val4 = float(dict_action[key]+ 0.09 * (dict_action[key]))
		...
		#stn_file.write("c: n" + str(val1) + ".start - .zero in [" + str(dict_start_action[key]) + "," + str(dict_start_action[key]) + "];\n")
		#action duration
		stn_file.write("c: n" + str(val1) + ".end - n" + str(val1) + ".start in [" + str(val3) + "," + str(val4) + "];\n")
