...
stn_file = open(sys.argv[1] + "_01.stn", "w") 
...
for key,value in sorted (dict_action.iteritems()):
	...
	if key != "0" and val1 < total_action:
		#print(val1)
		val2 = val1 + 1
		val3 = float(dict_action[key]- 0.01 * (dict_action[key]))
		val4 = float(dict_action[key]+ 0.01 * (dict_action[key]))
		#action sepration
		#stn_file.write("c: n" + str(val2) + ".start - n" + str(val1) + ".end in [0.001,0.001];\n")
